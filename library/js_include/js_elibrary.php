...
<?php 
	$database = new Js_Dbconn();			
		...
		$js_db_query = "SELECT * FROM js_elibrary ORDER BY itemid DESC LIMIT 20";
		$results = $database->get_results( $js_db_query );
	?>
	  <div id="content">
        <div class="content_item">
		<br>
		  <h1><?php echo $database->js_num_rows( $js_db_query ) ?> Elibrary Materials
          ...
          <br><hr><br>
			...
			<input type="text" name="js_search" id="js_search" placeholder="Search the library" />
			</td><td>
